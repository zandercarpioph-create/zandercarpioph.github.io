...
concentrated rather than citywide: the worst tenth of barangays carry 32\% of
reported cases and half of all cases fall inside 23\% of the city, a Gini of 0.39,
which argues for targeted rather than uniform control. Also found two defects that
silently corrupt naive analysis: counts mislabelled as rates, and delimiter
collisions inside area names.

\vspace{4pt}
\proj{Compartmental epidemic models}{R, deSolve, Shiny}
