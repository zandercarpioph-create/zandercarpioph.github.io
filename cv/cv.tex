...
\vspace{4pt}
\proj{Cholera under dual transmission, vaccination and disinfection}{MATLAB, R}{May 2026}
Four-author paper with A. G. C. Alilio, J. M. Anggaco and K. G. Canor. Extended a
published SEIRB model with an exposed compartment for the incubation delay, proved
well-posedness, derived both equilibria and obtained $R_0$ by the next generation
matrix. The disease-free equilibrium is locally asymptotically stable for $R_0 < 1$.
The structural change moved the policy conclusion: vaccination became the dominant
lever on $R_0$ where the basis model had emphasised environmental control.
